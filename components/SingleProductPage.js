  ...
  return (
    <div className="w-full">
      <div className="w-full max-w-[90%] m-auto py-10">
        ...
        <div className="w-full flex flex-col lg:flex-row 2xl:flex-row">
          <div className=" flex w-full lg:w-[80%] h-[400px]"></div>

          <div className="flex w-full lg:w-[20%] h-[400px] bg-[#f5f5f5] border border-gray-100">
              ...
              {orderType === "net" ? (
                <div className="bg-white flex flex-col p-5 flex-1">
                  ...
                  <div className="flex justify-center items-center mt-10">
                    <button className="py-3 px-20 text-white font-bold  text-lg bg-giganttiCartBgLeft hover:bg-giganttiCartBgRight rounded-3xl">
                      Lisää ostoskoriin
                    </button>
                  </div>
                </div>
